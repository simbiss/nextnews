...
const HomePage = () => {
  ...
  return (
    <div className="container mx-auto px-4">
      <h1 className='text-4x1 font-bold text-center my-6'>Next.js Routing</h1>
      <h2 className="text-2xl font-semibold my-4">Routage Statique</h2>
      <Link legacyBehavior href="/about"><a className="text-blue-500 hover:text-blue-700 transition duration-300">À propos</a></Link> |
